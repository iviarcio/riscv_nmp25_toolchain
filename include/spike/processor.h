...
public:
  ...
  // Code Added for NMP 
  //------------------------------------------------------------- 
  bool sema_sop_done = 0;  // Used for signal_n_wait instruction

  bool is_tlt_mem_acc = 0;  // Used for MADDR,MDATA host accesses.
  //------------------------------------------------------------- 
  ...
  uint32_t tl_id;
  bool tlt_start=0;
  void stat_insn_dump(insn_t insn); // dump instruction and print an instruction
  std::unordered_map<std::string,uint32_t> insn_count;
  //------------------------------------------------------------- 
